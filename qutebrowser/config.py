...
c.url.default_page = 'file:///home/kito/.config/qutebrowser/homepage.html'
c.url.start_pages = 'file:///home/kito/.config/qutebrowser/homepage.html'
...
config.bind(',lh', 'config-cycle content.user_stylesheets ~/.config/qutebrowser/solarized-everything-css/css/gruvbox/gruvbox-all-sites.css ""')

config.bind(',bo', 'set-cmd-text -s :bookmark-load ')
config.bind(',ba', 'bookmark-add')

config.bind('D', 'open file:///home/kito/.config/qutebrowser/homepage.html ')
